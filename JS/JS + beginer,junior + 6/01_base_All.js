...
// const age = 26
// let x
// console.log(typeof isProgrammer) // typeof переменныйдың типін анықтап береді
...
console.log("object: " + person["lastName"]);
const key = "year";
console.log(person[key]); // year key-орнына барады  сонда person.year болып обьект шаҚырады
// person.hasWife = true;
// person.isProgrammer = true; // person обьектТІСІНЕ ЖАңа элемент қосу
// console.log(person);
