            ...
            <li class="footer__item">
              <a href="">
                ...
                <img
                  ...
                  src="@/assets/images/instagram-2.svg"
                  alt=""
                />
              </a>
            </li>
          ...
          <a class="footer-right__help">
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M0 10C0 4.4775 4.4775 0 10 0C15.5225 0 20 4.4775 20 10C20 15.5225 15.5225 20 10 20C4.4775 20 0 15.5225 0 10ZM11.125 12.0019H8.98895V11.8609C8.99987 9.89532 9.48061 9.60745 10.3629 9.0791C10.4561 9.02327 10.5539 8.96475 10.656 8.90128C11.3865 8.44247 11.9479 7.86292 11.9479 7.01775C11.9479 6.06996 11.2054 5.45419 10.2817 5.45419C9.4305 5.45419 8.62467 5.85206 8.57034 6.987H6.30371C6.36408 4.69296 8.18086 3.5 10.2938 3.5C12.5999 3.5 14.1876 4.94709 14.1876 6.98757C14.1876 8.37003 13.4934 9.27557 12.3826 9.93963C12.298 9.99152 12.2187 10.0392 12.1445 10.0839C11.3554 10.559 11.1361 10.6911 11.125 11.8609V12.0019ZM11.2958 15.014C11.2897 15.7505 10.68 16.3421 9.96765 16.3421C9.23115 16.3421 8.63349 15.7505 8.63953 15.014C8.63349 14.2896 9.23115 13.698 9.96765 13.698C10.68 13.698 11.2897 14.2896 11.2958 15.014Z"
                fill="#6F6F6F"
              />
            </svg>
            <span>Помощь</span>
          </a>
          <div class="footer-right__language">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
...
.footer__item:hover .footer__icon-2 {
  display: block;
}
.footer__item:hover .footer__icon-1 {
  display: none;
}
.footer-right__help,
.footer-right__language {
  display: flex;
  align-items: center;
  color: #6f6f6f;
  font-size: 14px;
...
.footer-right__help svg,
.footer-right__language svg {
  margin-right: 16px;
}
.footer-right__help {
  margin-right: 64px;
